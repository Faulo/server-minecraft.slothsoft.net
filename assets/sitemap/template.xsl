...
<xsl:stylesheet version="1.0" xmlns="http://schema.slothsoft.net/farah/sitemap" xmlns:sfd="http://schema.slothsoft.net/farah/dictionary"
	...
	<xsl:template match="/*">
		<domain name="minecraft.slothsoft.net" vendor="slothsoft" module="minecraft.slothsoft.net" ref="pages/home" status-active="" status-public="" sfd:languages="en-us" version="1.1">
